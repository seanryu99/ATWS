###########################################################################
## Makefile generated for Simulink model 'ATWS'. 
## 
## Makefile     : ATWS.mk
## Generated on : Fri Feb 17 09:25:34 2017
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\ATWS.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\seanryu\ONEDRI~1\Works\ATWS
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
MODELREF_LINK_RSPFILE_NAME = ATWS_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = ATWS_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\ATWS.exe
...
INCLUDES_BUILDINFO = $(MATLAB_ROOT)\simulink\include\sf_runtime;$(START_DIR)\ATWS_ert_rtw;$(START_DIR);$(START_DIR)\models;$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=ATWS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)\ATWS_ert_rtw\ATWS.c

MAIN_SRC = $(START_DIR)\ATWS_ert_rtw\ert_main.c
...
{$(START_DIR)\ATWS_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\ATWS_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
